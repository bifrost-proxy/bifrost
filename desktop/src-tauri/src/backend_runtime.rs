...
pub(super) enum WatchdogProbeDisposition {
    Healthy,
    Recovered {
        failures: u32,
...
pub(super) struct BackendWatchdogHealth {
    first_failure_at: Option<Instant>,
    consecutive_failures: u32,
}

impl BackendWatchdogHealth {
    pub(super) fn observe_success(&mut self, now: Instant) -> WatchdogProbeDisposition {
    ...
    pub(super) fn observe_failure(&mut self, now: Instant) -> WatchdogProbeDisposition {
