...
fn get_protocol_description(protocol: Protocol) -> &'static str {
    match protocol {
        ...
        Protocol::Pac => "PAC proxy auto-config (not yet implemented)",
...
fn get_protocol_example(protocol: Protocol) -> &'static str {
    match protocol {
        ...
        Protocol::Pac => "pac://https://example.com/proxy.pac (not yet implemented)",
        ...
        Protocol::HeaderReplace => "headerReplace://req.header-name:old=new",
