...
//!    Priority: `override > config.instructions > default template`
//!
//! 2. **Environment Context** - Runtime info (cwd, shell, OS, arch, date) rendered as XML.
//!
//! 3. **User Instructions** - AGENTS.md + config-level instructions, rendered as XML block.
//!
//! 4. **Skills Instructions** - Budget-aware skill list with progressive disclosure.
//!
...
pub fn build_system_prompt_with_skill_registry(
    ...
    // Step 6: Build user instructions section
...
mod tests {
    ...
    fn test_assemble_prompt_full() {
        ...
        let result = assemble_prompt(&base, env, skills, user);
