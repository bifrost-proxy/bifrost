...
async fn breakpoint_settings_and_resume_validate_bodies_and_apply_edits() {
    ...
    let request_rx = manager.pause(pending("edit", "request"), true);
    assert_eq!(
        resume(
            &client,
            &base,
    ...
    let _phase_rx = manager.pause(pending("phase", "request"), true);
    assert_eq!(
        resume(
            &client,
            &base,
    ...
    let response_rx = manager.pause(pending("response-edit", "response"), true);
    assert_eq!(
        resume(
            &client,
            &base,
