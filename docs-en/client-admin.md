> Language: **English** | [中文](../docs/client-admin.md)
...
Rejected commands are not executed locally on the caller. To operate target files, shells, processes, or repositories, explicitly switch to `bifrost remote`; see the [CLI command reference](./cli.md).
