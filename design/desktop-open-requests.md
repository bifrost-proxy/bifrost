...
- E2E contract:
  ...
  - Before running the desktop crate `open_requests` Rust test, the contract builds `web/dist-desktop`, builds the debug CLI sidecar, and prepares `desktop/src-tauri/resources/bin/*`, matching Tauri's resource requirements on clean macOS/Windows runners.
