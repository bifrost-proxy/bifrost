...
critical_pattern='Rules 页面置顶并保护全局 Default|Values 页面完成 CRUD|Values 页面支持 bifrost-file|Scripts 页面完成创建、测试、push|加载流量列表并显示详情|Traffic toolbar exposes one global Breakpoint|AI new chat landing sends pasted images|WebKit 与 Chromium 中侧栏内容完整且小窗口可滚动'
