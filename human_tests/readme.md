...
| [install-binary-one-click.md](./install-binary-one-click.md) | 二进制安装脚本一键体验 | 5 | `install-binary.sh` 默认 post-install 自动安装并信任 CA、安装所有 Bifrost skills、后台启动服务，覆盖命令顺序、全局 opt-out、分步 opt-out 和 help 文案 |
