...
> 此页面由 `docs/client-admin.md` 自动同步生成。
# Client 远程管理使用手册

> Language: **中文** | [English](../en/reference/client-admin)
...
这些命令被拒绝后不会在调用端本地执行。如果需要操作目标机文件、shell、进程或仓库，请明确切换到 [Remote Invoke](./cli#远程调用remote)。
