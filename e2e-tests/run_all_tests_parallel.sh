...
FIXTURE_ONLY_RULES=(
    ...
    "devtools/page_bridge_basic.txt"
    ...
    "regression/rule_filter_routing_diagnostics.txt"
    "regression/rule_semantics_split_parsing.txt"
    "replay/delete_header.txt"
    "replay/forward_localhost_api.txt"
    "replay/full_modify_matrix.txt"
    "replay/host_redirect.txt"
    "replay/method_post.txt"
    "replay/multiple_rules.txt"
    "replay/path_prefix_forward.txt"
    "replay/referer.txt"
    "replay/request_body_mutations.txt"
    "replay/req_body.txt"
