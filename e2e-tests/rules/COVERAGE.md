...
- `tests/test_desktop_traffic_detail_window_contract.sh`：验证 Traffic 独立详情在桌面端通过异步 Tauri command 创建固定标签原生窗口，详情参数安全编码、窗口 capability、关闭事件和浏览器 popup 兼容分支均有自动化回归。
